...
// static HTML at the beginning of the page
	private static final String CARDS_PAGE_VIEW_START = "<div classname=\"gaer add-list\"> ";
    ...
    "        height=\"100\" " +
    "      /> " +
    "      <div class=\"product-variant-name\">%2$s</div> " +
    "        <form method=\"post\" action=\"/maliarskeplatno/eshop/0/0/6/%1$s\"> " +
    "          <div class=\"input-spinner-group\" data-input-spinner=\"\"> " +
    "          <span class=\"input-spinner-btn btn-l\"><button type=\"button\" class=\"spin-dec\">-</button></span> " +
    "          <input name=\"kusy\" value=\"3\" class=\"prKs quantity-input spin-input\" maxlength=\"6\" size=\"6\"> " +
